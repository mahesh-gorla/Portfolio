        ...
        return (
            <div className="dark-voice">
              <p className="text-center">
                  ...
                  <br/>
                  Ready for hard work and serious responsibilities.
Teamwork, respect, honesty, professionalism and eagerness for success are
necessary attributes for every job and I believe that I posses them.
              <br/>
                    <b className="dark-voice-tag">&#x3C;/voice&#x3E;</b>
              </p>
